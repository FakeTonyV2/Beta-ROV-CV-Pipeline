...
| MODEL_NOT_FOUND | module | artifact absent | FAILED | ERROR | 75 | deploy model | test_model_not_found |
| MODEL_HASH_MISMATCH | module | checksum differs | FAILED | ERROR | 75 | replace artifact | test_model_hash_mismatch |
| MODEL_LOAD_FAILED | module | loader error | FAILED | ERROR | 75 | inspect artifact/runtime | test_model_load_failed |
| RUNTIME_UNAVAILABLE | module | runtime missing | FAILED | ERROR | 75 | install runtime | test_runtime_unavailable |
| TARGET_INCOMPATIBLE | module | artifact incompatible | FAILED | ERROR | 75 | deploy compatible artifact | test_target_incompatible |
...
| TARGET_SEND_TIMEOUT | control router | send deadline elapsed | N/A client outcome | unchanged | 0 | retry command | test_target_send_timeout |
...
| PROCESSING_WATCHDOG_EXCEEDED | module | deadline exceeded | N/A diagnostic | DEGRADED | 0 | reduce load/restart | test_processing_watchdog_exceeded |
